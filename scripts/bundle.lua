...
local ROJO_INPUT = "website/static/mollermethod.rbxm"
local RUNTIME_FILE = "scripts/runtime.lua"
local BUNDLE_TEMP = "scripts/bundle.tmp"
...
local function minify(source)
	...
	os.execute("node scripts/minify.js")
