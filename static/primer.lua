--[[
	...
	gray = {
		...
		Color3.fromRGB(177, 186, 196),
		Color3.fromRGB(139, 148, 158),
		Color3.fromRGB(110, 118, 129),
		Color3.fromRGB(72, 79, 88),
	...
	yellow = {
		...
		Color3.fromRGB(242, 204, 96),
		Color3.fromRGB(227, 179, 65),
		Color3.fromRGB(210, 153, 34),
		Color3.fromRGB(187, 128, 9),
		Color3.fromRGB(158, 106, 3),
	...
	orange = {
		...
		Color3.fromRGB(255, 198, 128),
		Color3.fromRGB(255, 166, 87),
		Color3.fromRGB(240, 136, 62),
		Color3.fromRGB(219, 109, 40),
		Color3.fromRGB(189, 86, 29),
	...
	pink = {
		Color3.fromRGB(255, 218, 236),
		Color3.fromRGB(255, 190, 221),
		Color3.fromRGB(255, 155, 206),
		Color3.fromRGB(247, 120, 186),
		Color3.fromRGB(219, 97, 162),
		Color3.fromRGB(191, 75, 138),
		Color3.fromRGB(158, 54, 112),
		Color3.fromRGB(125, 36, 87),
		Color3.fromRGB(94, 16, 62),
		Color3.fromRGB(66, 6, 42)
	},
	coral = {
		Color3.fromRGB(255, 221, 210),
		Color3.fromRGB(255, 194, 178),
		Color3.fromRGB(255, 162, 139),
		Color3.fromRGB(247, 129, 102),
		Color3.fromRGB(234, 96, 69),
		Color3.fromRGB(207, 70, 45),
		Color3.fromRGB(172, 50, 32),
		Color3.fromRGB(135, 32, 18),
		Color3.fromRGB(100, 13, 4),
		Color3.fromRGB(70, 7, 1)
	}
}
